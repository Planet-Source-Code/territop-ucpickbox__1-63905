...
'                 dialog type.
'       16Mar06 - Added Paul Caton's SelfSubclass Thunk code to allow for BrowseForFolder CallBack without the
...
'       28Jun06 - Fixed TrimPathByLen method to be independent of the printer object.
'
'   Force Declarations
Option Explicit
'
